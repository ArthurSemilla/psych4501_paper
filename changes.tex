...
%DIF ADD paper_rev.tex   Thu Dec 10 17:38:55 2015
...
The film \DIFdelbegin \DIFdel{portrays }\DIFdelend \DIFaddbegin \DIFadd{portrayed }\DIFaddend the psychological effects \DIFdelbegin \DIFdel{have }\DIFdelend \DIFaddbegin \DIFadd{war has }\DIFaddend on many characters, prominently Willard, Chef, and Lance.

Willard exhibits many symptoms throughout the film, many of which fall under the diagnosis of \DIFdelbegin \DIFdel{Post-Traumatic Stress Disorder . Using the DSM-V, the following symptoms can be evaluated as such }\DIFdelend \DIFaddbegin \DIFadd{Posttraumatic Stress Disorder (PTSD). The following symptoms of PTSD are exhibited by Willard }\DIFaddend (American Psychiatric Association, 2013):
\begin{itemize}
...
\end{itemize}
The first three points would prevent a diagnosis of PTSD for Willard, while the last would not necessarily effect the diagnosis either way, since it is part of a subset of symptoms that Willard exhibits (American Psychiatric Association, 2013). His obsession with returning to the jungle could \DIFdelbegin \DIFdel{be though as part of Obsessive-Compulsive Disorder, however }\DIFdelend \DIFaddbegin \DIFadd{exhibit symptoms of Obsessive Compulsive Disorder, but }\DIFaddend the obsession is not unwanted, not causing stress, and there are no cleansing compulsions to reduce or get rid of the obsession (American Psychiatric Association, 2013).

Chef seems a rather normal man by military standards, interacting with his crew, coping with the situations he has faced rather well. However, the hellish mission he embarks on with Willard causes \DIFdelbegin \DIFdel{this }\DIFdelend \DIFaddbegin \DIFadd{his mental state }\DIFaddend to change. As they continue further up the Nung River, Chef begins to develop symptoms of Acute Stress Disorder as follows (American Psychiatric Association, 2013):
\begin{itemize}
...
\end{itemize}
Although he also has symptoms of a \DIFdelbegin \DIFdel{substance abuse disorder}\DIFdelend \DIFaddbegin \DIFadd{Substance Use Disorder}\DIFaddend , specifically when he and Lance start excessive \DIFaddbegin \DIFadd{drug }\DIFaddend use after Clean's death, this is a response to the stress, and thus would not be Substance Use Disorder, \DIFaddbegin \DIFadd{but }\DIFaddend rather Acute Stress Disorder with a response of substance use. \DIFdelbegin \DIFdel{However, }\DIFdelend \DIFaddbegin \DIFadd{But }\DIFaddend even with these \DIFaddbegin \DIFadd{symptoms }\DIFaddend present, there is a definitive lack of \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{any }\DIFaddend dissociative symptoms. He also exhibits no intrusion symptoms since no flashbacks are present, and the intense and prolonged stress is not caused from the traumatic events specifically, but are rather the stressful events in the moment (American Psychiatric Association, 2013). 

Lance begins the film a very naive, California surfer, almost out of place in the Vietnam War. As more \DIFdelbegin \DIFdel{and more }\DIFdelend significantly stressful events occur, he relapses into a shell, showing signs of Major Depressive Disorder (American Psychiatric Association, 2013):
\begin{itemize}
...
\end{itemize}
However, there are not enough \DIFdelbegin \DIFdel{shown }\DIFdelend symptoms to diagnose Lance with Major Depressive Disorder. Instead, he might be experiencing \DIFdelbegin \DIFdel{Depressive }\DIFdelend \DIFaddbegin \DIFadd{a depressive }\DIFaddend episode with insufficient symptoms. This \DIFdelbegin \DIFdel{would be a more accurate diagnosis with the known symptoms }\DIFdelend \DIFaddbegin \DIFadd{diagnosis would be more accurate given the symptoms exhibited }\DIFaddend in the film, as well as the lack of any manic episodes or other bipolar specific symptoms (American Psychiatric Association, 2013). He could also be diagnosed with PTSD, using the death of Clean and Chief as the trauma. Similarly to Chef, he could be diagnosed with a substance use response, since the substance use only appeared after the original symptoms for depression or PTSD.

\section{Conclusion}	

According to the DSM-V, Willard is the only person who \DIFdelbegin \DIFdel{could get diagnosed with a disorder, in his case }\DIFdelend \DIFaddbegin \DIFadd{met the diagnosis for }\DIFaddend PTSD. Chef could possibly have more symptoms, however\DIFdelbegin \DIFdel{the film does }\DIFdelend \DIFaddbegin \DIFadd{, the film did }\DIFaddend not portray them. Further, he could have an Unspecified \DIFdelbegin \DIFdel{Trauma- }\DIFdelend \DIFaddbegin \DIFadd{Trauma }\DIFaddend and
Stressor-Related Disorder, since his \DIFaddbegin \DIFadd{lack of }\DIFaddend symptoms are not definitive of Acute Stress Disorder or another specific stress disorder. Lance could be diagnosed with Major Depressive Disorder, although it would require more symptoms to be present. With the films portrayal, it is more likely he is diagnosed with a \DIFdelbegin \DIFdel{Depressive }\DIFdelend \DIFaddbegin \DIFadd{depressive }\DIFaddend episode lacking sufficient symptoms or PTSD with catatonic behaviors, since he changed his behaviors after the death of Clean. Lance and Chef could both also have \DIFdelbegin \DIFdel{an Substance Use }\DIFdelend \DIFaddbegin \DIFadd{a Substance Use Disorder }\DIFaddend added as a response to their potential diagnosis. \\
